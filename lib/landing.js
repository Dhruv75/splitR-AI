...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr has streamlined our expense tracking, making team collaborations effortless and transparent.",
    name: "Ankit Mehra",
    image: "/testimonials/kds.jpg",
    role: "Project Manager",
  },
  {
    quote:
      "Managing shared finances used to be a challenge, but Splitr’s intuitive interface and accurate calculations have made it simple and reliable.",
    name: "Rahul Verma",
    image: "/testimonials/emen.jpg",
    role: "Finance Analyst",
  },
  {
    quote:
      "With Splitr, settling group expenses is now quick and stress-free, allowing us to focus on what truly matters—our work.",
    name: "Priya Singh",
    image: "/testimonials/ppddl.jpg",
